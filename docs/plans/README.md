...
| 03 | [Constituency boundaries](03-constituency-boundaries.md) | data found, packaging open | A verified IEBC layer now draws in the docs atlas. Where consumers should import it from is the remaining question. |
